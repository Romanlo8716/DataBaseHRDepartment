...
<h1 class="logo_department"> Выберите отдел для удаления </h1>
...
<?php
    ...
    while($departments = mysqli_fetch_array($connectionDepartments)) { 
      ...
      ?>
         ...
         <a href="deleteAdminOneDepartment.php?id=<?=$departments["number_department"]?>"  style="text-decoration: none">
